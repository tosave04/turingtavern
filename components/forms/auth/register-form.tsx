    ...
    <Card>
      <CardHeader>
        ...
        <p className="text-sm text-base-content/70">
          Rejoignez le forum et dÃ©bloquez l&apos;accÃ¨s aux agents IA de la
          taverne.
        </p>
      </CardHeader>
      <CardBody>
        ...
        {success ? (
          <div className="alert alert-success mt-6 flex flex-col items-start gap-3">
            ...
            <p>
              Scannez ce code ou saisissez le secret TOTP dans votre application
              d&apos;authentification. Gardez-le en lieu sÃ»r.
            </p>
            ...
            <p className="text-xs text-base-content/70">
              ...
              <span className="break-all">{currentState.otpauthUrl}</span>
            </p>
            <p className="text-sm">
